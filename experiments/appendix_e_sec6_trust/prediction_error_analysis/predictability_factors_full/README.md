...
- `sec6_trust/prediction_error_analysis/benchmark_analysis/H1_*`--`H3_*/results.json`
- `sec6_trust/prediction_error_analysis/benchmark_analysis/H4_*`--`H7_*/ablation_results.json`
...
```bash
cd ~/Documents/submission/benchpress/github/experiments/appendix_e_sec6_trust/prediction_error_analysis/predictability_factors_full
python plot_full.py
```
