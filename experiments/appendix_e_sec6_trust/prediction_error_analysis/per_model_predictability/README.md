...
`appendix_e_sec6_trust/prediction_error_analysis/per_benchmark_predictability/`.

## Data reuse (no recompute)

Aggregation only — we reuse the canonical raw predictions stored in
`appendix_e_sec6_trust/prediction_error_analysis/per_benchmark_predictability/results.json`
...
```bash
cd ~/Documents/submission/benchpress/github/experiments/appendix_e_sec6_trust/prediction_error_analysis/per_model_predictability
