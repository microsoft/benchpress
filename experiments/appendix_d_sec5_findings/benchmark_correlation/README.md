...
- Appendix D.1, `\Cref{app:probe_selection}`
...
```bash
cd experiments/appendix_d_sec5_findings/benchmark_correlation
...
- `pairwise_ols_stats.json`: best-neighbor table source for Appendix D.1
...
Current Appendix D.1 text reports 132 benchmarks with at least one valid neighbor pair, 127 with best-neighbor `|r| >= 0.85`, and median best-neighbor absolute correlation 0.97.
