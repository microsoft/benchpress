...
H1 tests whether model parameter count predicts model-side BenchPress error. The feature is `log_params`.
...
Current protocol: 84 x 133 score matrix, model hide-half holdout, `N_SEEDS = 10`, `SEED = 42`, feature `log_params`.
