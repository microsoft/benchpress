...
H2 tests whether reasoning-model status predicts model-side BenchPress error. The feature is `is_reasoning`.
...
Current protocol: 84 x 133 score matrix, model hide-half holdout, `N_SEEDS = 10`, `SEED = 42`, feature `is_reasoning`.
