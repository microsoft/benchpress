...
```bash
cd ~/Documents/submission/benchpress/github/experiments/sec6_trust/prediction_error_analysis/benchmark_analysis
...
```bash
cd experiments/sec6_trust/prediction_error_analysis/benchmark_analysis
